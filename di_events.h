...
//GPIO port defines
//GPIO0: P4.2
#define GPIO0_IN (P4IN & BIT2)
#define GPIO0_SET (P4OUT |= BIT2)
#define GPIO0_CLR (P4OUT &= ~BIT2)
#define GPIO0_OUTPUT_DIR (P4DIR |= BIT2)
#define GPIO0_INPUT_DIR (P4DIR &= ~BIT2)
//GPIO1: P4.1
#define GPIO1_IN (P4IN & BIT1)
#define GPIO1_SET (P4OUT |= BIT1)
#define GPIO1_CLR (P4OUT &= ~BIT1)
#define GPIO1_OUTPUT_DIR (P4DIR |= BIT1)
#define GPIO1_INPUT_DIR (P4DIR &= ~BIT1)
//GPIO2: P4.3
#define GPIO2_IN (P4IN & BIT3)
#define GPIO2_SET (P4OUT |= BIT3)
#define GPIO2_CLR (P4OUT &= ~BIT3)
#define GPIO2_OUTPUT_DIR (P4DIR |= BIT3)
#define GPIO2_INPUT_DIR (P4DIR &= ~BIT3)
//GPIO3: P4.0
#define GPIO3_IN (P4IN & BIT0)
#define GPIO3_SET (P4OUT |= BIT0)
#define GPIO3_CLR (P4OUT &= ~BIT0)
#define GPIO3_OUTPUT_DIR (P4DIR |= BIT0)
#define GPIO3_INPUT_DIR (P4DIR &= ~BIT0)
//GPIO4: P2.2
#define GPIO4_IN (P2IN & BIT2)
#define GPIO4_SET (P2OUT |= BIT2)
#define GPIO4_CLR (P2OUT &= ~BIT2)
#define GPIO4_OUTPUT_DIR (P2DIR |= BIT2)
#define GPIO4_INPUT_DIR (P2DIR &= ~BIT2)
//GPIO5: P2.6
#define GPIO5_IN (P2IN & BIT6)
#define GPIO5_SET (P2OUT |= BIT6)
#define GPIO5_CLR (P2OUT &= ~BIT6)
#define GPIO5_OUTPUT_DIR (P2DIR |= BIT6)
#define GPIO5_INPUT_DIR (P2DIR &= ~BIT6)
//GPIO6: P4.5
#define GPIO6_IN (P4IN & BIT5)
#define GPIO6_SET (P4OUT |= BIT5)
#define GPIO6_CLR (P4OUT &= ~BIT5)
#define GPIO6_OUTPUT_DIR (P4DIR |= BIT5)
#define GPIO6_INPUT_DIR (P4DIR &= ~BIT5)
//GPIO7: P4.6
#define GPIO7_IN (P4IN & BIT6)
#define GPIO7_SET (P4OUT |= BIT6)
#define GPIO7_CLR (P4OUT &= ~BIT6)
#define GPIO7_OUTPUT_DIR (P4DIR |= BIT6)
#define GPIO7_INPUT_DIR (P4DIR &= ~BIT6)
#endif	//DISP_EAGLE
